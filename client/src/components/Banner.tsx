...
const Banner = () => {
  ...
  return (
    <div>{bannerVisible &&(
        <div role="region" aria-label="Delivery announcement" className="bg-linear-to-r from-app-green via-emerald-800 to-app-green text-white text-xs sm:text-sm relative overflow-hidden">
            ...
            <button aria-label="Dismiss delivery announcement" onClick={dismissBanner} className="absolute right-2 top-1/2 -translate-y-1/2 p-1 hover:bg-white/10 rounded-full transition-colors">
