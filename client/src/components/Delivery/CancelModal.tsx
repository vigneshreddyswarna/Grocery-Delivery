    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-50 flex-center p-4">
                <div role="dialog" aria-modal="true" aria-labelledby="cancel-delivery-title" className="bg-white rounded-2xl p-6 w-full max-w-sm animate-fade-in">
                    <h3 id="cancel-delivery-title" className="text-lg font-semibold text-red-600 mb-2">Cancel Delivery</h3>
                    <p className="text-sm text-zinc-500 mb-4">Please provide a reason for cancellation.</p>
                    <textarea aria-label="Cancellation reason" autoFocus value={cancelReason} onChange={(e) => setCancelReason(e.target.value)} rows={3} placeholder="Reason..." className="w-full px-4 py-3 text-sm rounded-xl border border-app-border focus:border-red-400 outline-none resize-none mb-4" />
