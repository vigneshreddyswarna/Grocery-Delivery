...
//                             <input type="text" value={name} onChange={(e)=>setName(e.target.value)} required placeholder="Your name" className="w-full pl-11 pr-4 py-3 text-sm bg-white rouned-xl border not-focus:border-app-border transition-all"/>
...
//                             <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} required placeholder="You@example.com" className="w-full pl-11 pr-4 py-3 text-sm bg-white rouned-xl border not-focus:border-app-border transition-all"/>
...
//                             <input type="password" value={password} onChange={(e)=>setPassword(e.target.value)} required placeholder="........" className="w-full pl-11 pr-4 py-3 text-sm bg-white rouned-xl border not-focus:border-app-border transition-all"/>
...
const Login = () => {
    ...
    // Fixed: Changed React.SubmitEvent to React.FormEvent<HTMLFormElement>
